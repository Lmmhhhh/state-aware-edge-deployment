...
def main():
    ...
    print("[workload=image_classification][model=mobilenetv3_large][mode=single][device=jetson] start")
    ...
    print(
        f"[workload=image_classification][model=mobilenetv3_large][mode=single][device=jetson] "
