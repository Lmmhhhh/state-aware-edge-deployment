...
def main():
    ...
    print("[workload=image_classification][model=resnet50][mode=single][device=jetson] start")
    ...
    print(
        f"[workload=image_classification][model=resnet50][mode=single][device=jetson] "
