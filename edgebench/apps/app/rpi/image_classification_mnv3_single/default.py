...
def main():
    ...
    print("[workload=image_classification][model=mobilenetv3_large][mode=single][device=rpi] start")
    ...
    print(
        f"[workload=image_classification][model=mobilenetv3_large][mode=single][device=rpi] "
